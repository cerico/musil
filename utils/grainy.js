function Municipal (id) {
    ...
    Municipal.prototype.baths = function(node,opts){
		console.log(node)
	}

	Municipal.prototype.grainy = function(node,opts) {
		var options = Object.assign({}, Municipal.prototype.grainy.defaults, opts);
		...
		var imgUri = "url('" + uri+ "')"
		node.style.backgroundImage =  imgUri
		node.style.backgroundColor =  opts.backgroundColor
		return node.style

	};
	Municipal.prototype.defaults = {
...
export const municipal = new Municipal()